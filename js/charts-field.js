...
AmCharts.makeChart("chartdiv14", {
    ...
    "graphs": [
        ...
        },
        {
            ...
            "id": "AmGraph-9",
            "lineThickness": 2,
            "title": "Выдано лицензий всего по результатам аукциона за отчетный период \t",
            "valueField": "column-9"
        }
    ],
    "guides": [],
    ...
    "titles": [
        {
            "id": "Title-1",
            "size": 18,
            "text": "Сведения о массиве лицензий на право пользования недрами за 2004-2016 гг. по РФ"
        }
    ],
    "dataProvider": [
        {
